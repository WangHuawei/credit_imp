...
import CreateEnquiryFileIndex from '@/views/ccdrm/CreateEnquiryFile/Index'
import ApplicationStatus from '@/views/ccdrm/ApplicationStatus'
import SearchCustomer from '@/views/ccdrm/SearchCustomer'
import ProcessResponseFileIndex from '@/views/ccdrm/ProcessResponseFile/Index'
    ...
    },
    {
      ...
      children:[
        ...
        },
        {
          ...
          name: 'CreateEnquiryFileIndex',
          component: CreateEnquiryFileIndex
        },
        {
          path: '/ccdrm/application-status',
          name: 'ApplicationStatus',
          component: ApplicationStatus
        },
        {
          path: '/ccdrm/search-customer',
          name: 'SearchCustomer',
          component: SearchCustomer
        },
        {
          path: '/ccdrm/process-response-file',
          name: 'ProcessResponseFileIndex',
          component: ProcessResponseFileIndex
        }
      ]
    }
  ]
